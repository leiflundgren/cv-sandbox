# from https://www.pyimagesearch.com/2017/04/24/eye-blink-detection-opencv-python-dlib/
...
if len(sys.argv) <= 1 :
    sys.argv = [sys.argv[0], '-p', 'shape_predictor_68_face_landmarks.dat', '-v', 'camera' ]
...
while True:
    ...
    for rect in rects:
        ...
        cv2.drawContours(frame, [noseHull], -1, (255, 128, 0, 2))

        jaw = shape[jaw_start:jaw_end]
        jawHull = cv2.convexHull(jaw)
        cv2.drawContours(frame, [jawHull], -1, (20, 128, 80, 2))
